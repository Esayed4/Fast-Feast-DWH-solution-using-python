...
def run_batch():
    ...
    for batch_folder in get_unprocessed_batches():
        ...
        try:
            ...
            # Step 5: generate dim_date for this batch date
# Step 5: generate dim_date for this batch date
# Step 5: generate dim_date
            ...
            # if dim_date is empty start from batch_date, otherwise from max_date + 1
            if max_date is None:
                start_dt = date.fromisoformat(batch_date)
            else:
